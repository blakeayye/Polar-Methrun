...
-- Sends Messages to Mail
Config.QbPhone = false
...
Config.MenuHeaderIcon = "fa-solid fa-circle-exclamation"

-- REQUESTING JOB
Config.MenuHeader2 = "Request Job"
Config.MenuText = "Request a Delivery Job"
Config.MenuHeaderIcon2 = "fa-solid fa-truck-arrow-right"

-- EXIT BUTTON
Config.MenuHeaderExit = "Exit"
Config.MenuIconExit = "fa-solid fa-circle-xmark"
